...
def banner():
    ...
    ▀████████▀  ▀██████▀   ▀█   ███   █▀  ▄█████████▀  █▀     ██████████ 
                            ...
                            || https://github.com/edgerunner0x01/ ||""",
    f"""{red}
        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣤⣤⣤⣤⣴⣤⣤⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ⠀⠀⠀⠀⠀⠀⠀⣀⣴⣾⠿⠛⠋⠉⠁⠀⠀⠀⠈⠙⠻⢷⣦⡀⠀⠀
        ⠀⠀⠀⠀⠀⣤⣾⡿⠋⠁⠀⣠⣶⣿⡿⢿⣷⣦⡀⠀⠀⠀⠙⠿⣦⣀⠀⠀⠀⠀
    ...
    f"""{red}          
         | |
       @#####@           ________    ______   ___      ___  _______   __     _______  
     (###   ###)-.      ("      "\  /    " \ |"  \    /"  ||   _  "\ |" \   /"     "| 
   .(###     ###) \      \___/   :)// ____  \ \   \  //   |(. |_)  :)||  | (: ______) 
  /  (###   ###)   )       /  ___//  /    ) :)/\\  \/.    ||:     \/ |:  |  \/    |
 (=-  .@#####@|_--"       //  \__(: (____/ //|: \.        |(|  _  \\ |.  |  // ___)
 /\    \_|l|_/ (\        (:   / "\\        / |.  \    /:  ||: |_)  :)/\  |\(:      "| 
(=-\     |l|    /         \_______)\"_____/  |___|\__/|___|(_______/(__\_|_)\_______) 
 \  \.___|l|___/    
 /\      |_|   /                    || https://github.com/edgerunner0x01/ ||
(=-\._________/\                
 \             /    
   \._________/
     #  ----  #
    ...
    print("\n"+banners[randint(0,len(banners)-1)]+"\n")
    sleep(1)
